...
if(data.length === 0) {
    ...
    // Ubah isInitialLoad menjadi !isInitialLoad agar animasi chat mati saat pertama buka
...
function scrollToBottom(isInstant = false) {
    const msgContainer = document.getElementById('seller-chat-messages');
    if (isInstant) {
        // Scroll instan 100% tanpa efek meluncur
        msgContainer.scrollTop = msgContainer.scrollHeight;
    } else {
        // Scroll smooth buat pesan yang baru masuk
